...
const Hero: React.FC<Props> = ({ session, user, subscription, products }) => {
  return (
    <>
      <div className={`${s.heroContainer} mx-auto  py-16 sm:py-16 sm:px-8`}>
        <Container className="mx-auto max-w-full w-full flex flex-col bg-blue-600 items-center justify-center py-8">
          <div className="flex flex-col mt-12 justify-center items-center px-4 text-center w-full">
            <div>
            <div>
              ...
              <h1 className="text-3xl text-center mb-10 font-extrabold sm:text-left text-left">
