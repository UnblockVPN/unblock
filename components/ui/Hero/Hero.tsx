        ...
        <div className="flex flex-col mt-2 max-w-6xl items-center px-4 text-left w-full">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <Link href="/order" className={`${s.link} px-8 py-2 font-medium text-center dark:bg-white bg-black rounded-full sm:text-white dark:text-black`}>
                Get started
              </Link>
              <Link href="/order" className={`${s.link} px-8 py-2 font-medium text-center dark:bg-white bg-black rounded-full text-white dark:text-black`}>
                View plans
              </Link>
            </div>
